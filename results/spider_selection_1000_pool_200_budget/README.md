...
| Method | Databases covered | Mean selection loss | Train time | Diagnostic exact match |
| --- | ---: | ---: | ---: | ---: |
...
The preliminary result is consistent with the idea that high-loss examples can
...
the evaluation set is small, only one seed was used, and normalized string
matching is stricter and less informative than official Spider evaluation.
